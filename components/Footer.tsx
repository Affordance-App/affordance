...
export const Footer: React.FC<Footer> = ({}) => {
  return (
    <footer className="bottom-0  w-full justify-center mb-12  items-center justify-between mx-auto container py-9 px-5">
      ...
      <div className="small flex justify-center  mt-3 text-gray items-center justify-center mx-auto">
